...
MaadyCyclop не открывает портов и не слушает сеть. Ни обновлений, ни телеметрии, ни
...
подтверждена Apple ID, а MaadyCyclop лишь читает то, что оказалось в буфере. Своего
...
## Что MaadyCyclop читает и где это лежит
...
**Снимки экрана из буфера** сохраняются файлами в `~/Pictures/MaadyCyclop` и не
...
**Заготовки** лежат в `~/Library/Application Support/MaadyCyclop/snippets.json`
