...
final class ShelfStore: ObservableObject {
    ...
    func remove(_ item: ShelfItem) {
        // A screenshot we wrote ourselves goes with the card. Anything else
        // is a reference — the original stays where the user left it.
        ScreenshotVault.trash(item.url)
